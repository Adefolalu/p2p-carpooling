...
const RenderCard = ({ label, link, image }) => {
  return (
...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>P2P CARPOOLING</title>
        <meta name="description" content="P2P CARPOOLING" />
      ...
      <div>
        <div className="max-w-5xl mx-auto p-2 text-white rounded-lg  py-8 z-50 relative">
          <div className="text-center">
            <h1 className={"font-bold text-3xl"}>Welcome to p2p Carpooling</h1>
